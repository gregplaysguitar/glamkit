...
# sphinx-quickstart on Tue Mar 23 18:00:38 2010.
#
...
sys.path.append(os.path.abspath('../../glamkit-eventtools/eventtools'))
print sys.path
...
latex_documents = [
  ('index', 'GLAMkit.tex', u'GLAMkit Documentation',
   u'Thomas Ashelford', 'manual'),
]
